...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/sebastianboehler/Documents/GitHub/nitro-app/.data/kv"}));
...
const _lazy_wcVau5 = () => import('../index.mjs');

const handlers = [
  { route: '/', handler: _lazy_wcVau5, lazy: true, middleware: false, method: undefined }
];
...
export { eventHandler as e, vercel as v };
